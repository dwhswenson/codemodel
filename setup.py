"""
setup.py for codemodel
"""

# this file is modified from the setup.py used in contact_map
import os
import sys
import subprocess
import inspect
...
if __name__ == "__main__":
    write_version_py(os.path.join('codemodel', 'version.py'))
    setup(
        name="codemodel",
        ...
        version=PACKAGE_VERSION,
        license="MIT",
        url="http://github.com/dwhswenson/codemodel",
        packages=PACKAGES,
